...
class Klee(EventBanner):
    def __init__(self):
        ...
        self.rate_up_four_star_pool = ["Sucrose", "Noelle", "Xingqiu"]
        self.banner_image = "https://static.wikia.nocookie.net/gensin-impact/images/5/54/Sparkling_Steps.jpg/revision/latest/scale-to-width-down/500?cb=20201018122142"
